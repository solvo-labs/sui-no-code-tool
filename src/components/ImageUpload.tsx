...
const ImageUpload: React.FC<Props> = ({ file, loading, title, setFile, handleClear }) => {
  ...
  return (
    <div>
      <label className="block mb-2 text-sm font-medium text-gray-900">Upload image (optional)</label>
      <div className="border-2 rounded-lg">
        ...
        {loading && (
          <div className="relative flex flex-row gap-8 p-4 justify-center items-center">
            ...
            <div
              role="status"
              className="absolute rounded-lg -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 bg-[rgb(0,0,0,0.6)] w-full h-full flex justify-center items-center"
            >
