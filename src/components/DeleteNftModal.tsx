...
const DeleteNftModal: React.FC<Props> = ({ open, burnNft, handleOpen, handleClose }) => {
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">If you confirm ownership of the NFT, it will be permanently deleted, and this action cannot be undone.</p>
                      </div>
                    </div>
                  </div>
                </div>
