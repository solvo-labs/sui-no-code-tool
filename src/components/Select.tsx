...
export const Select: React.FC<Props> = ({ title, options, selectedOption, onSelect, placeholder = "Select an option" }) => {
  return (
    <div className="relative inline-flex w-full flex-col">
      ...
      <select
        className="border border-gray-300 rounded-lg cursor-pointer text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-sui-blue appearance-none"
